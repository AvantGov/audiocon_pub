            ...
            <div className='ResidentialServices__service'>
                ...
                <div className='service__contentContainer'>
                    ...
                    <div className='contentContainer__copyContainer'>
                        ...
                        <p id="hometheater_bullet2" className='copyContainer__bullet'><span>&#8226;</span> Our team's goal is to deliver high performance sound & precise acoustic treatment, coupled with front projection and rear projection options that captivate a comfy audience. Don't forget, our team supplies top-notch theater furniture as well!</p>
            ...
            <div className='ResidentialServices__service'>
                ...
                <div className='service__contentContainer'>
                    ...
                    <div className='contentContainer__copyContainer'>
                        ...
                        <p id="wholehouse_bullet3" className='copyContainer__bullet'><span>&#8226;</span> Our technicians understand that the client experience is key to any successful installation. Expect tailored consultation and orientation upon installation, coupled with personalized controller setup. Wield an entire system from a smartphone, tablet, computer, smart tv ... and much more.</p>
                        <p id="wholehouse_bullet4" className='copyContainer__bullet'><span>&#8226;</span> Start small with portable networked smart speakers like Sonos and build a home system as time goes. Audio Contractors is here to help with every step from day 1 to beyond. Our technicians handle the footwork of updates, upgrades, troubleshooting issues, and regular service. </p>
                    </div>
                </div>
            </div>
            <div className='ResidentialServices__service'>
            ...
            <div className='ResidentialServices__service'>
                ...
                <div className='service__contentContainer'>
                    ...
                    <div className='contentContainer__copyContainer'>
                        ...
                        <p id="smartlighting_bullet2" className='copyContainer__bullet'><span>&#8226;</span> Pack it in for the evening and say 'goodnight' to the entire home with a single button press. Dim each indoor light gradually, and start the timer for the outdoor lights. Not a single light will stir, not in this house. </p>
            ...
            <div className='ResidentialServices__service'>
                ...
                <div className='service__contentContainer'>
                    ...
                    <div className='contentContainer__copyContainer'>
                        ...
                        <p id="networking_bullet3" className='copyContainer__bullet'><span>&#8226;</span> New construction project? Book some time to speak with one of our experts and collaboratively plan wiring protocols that deliver connection where it's needed most in the home. Additionally, our technicians are able to deliver structured wiring solution for complete cable and satellite distribution throughout the home.</p>
